...
public class ItemSlot : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler
{
    ...
    public GameObject selectNode;           // 选中效果
    ...
    private static ItemSlot draggedSlot;  // 当前正在被拖拽的槽（静态，方便交互）
    private static GameObject dragIcon;     // 拖拽物体的悬浮图标（静态，方便交互）
    private RectTransform rectTransform;    // 自身的 RectTransform
    private UnityAction<int> btnClickAction;    // 点击事件
    ...
    private void Awake()
    {
        ...
        {
            print($"btnOnClick_{slotIndex}");
            btnClickAction?.Invoke(slotIndex);
        });
    }
