...
using UnityEngine;
[CreateAssetMenu(fileName = "PlayerState_Attack02", menuName = "StateMachine/Player/Attack02")]
public class PlayerState_Attack02 : PlayerState
{
    ...
    public override void LogicUpdate()
    {
        ...
        if (playerCtrl.isAttacking && elapsed >= minNextAttackTime && elapsed <= maxNextAttackTime)
        {
            ...
            stateMachine.SwitchState(typeof(PlayerState_Attack03));
            return;
        }
