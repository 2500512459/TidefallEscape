...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void ResetBinding(InputAction action, int bindingIndex)
        {
            ...
            string oldOverridePath = newBinding.effectivePath;
            action.RemoveBindingOverride(bindingIndex);
        ...
        private bool CheckDuplicateBinding(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            foreach (InputBinding binding in action.actionMap.bindings)
            {
                ...
                {
                    Debug.LogError($"Duplicate binding found: {binding.effectivePath} on {binding.action}");
                    return true;
                }
            }
            ...
            if(allCompositeParts)
            {
                for(int i = 1; i < bindingIndex; i++)
                {
                    ...
                    {
                        Debug.LogError($"Duplicate binding found: {newBinding.effectivePath} on {newBinding.action}");
                        return true;
                    }
                }
            }
        ...
        [Tooltip("Optional bool field whitch allows you to OVERRIDE the action lable with your own text.")]
        public bool m_OverrideActionLabel;

        [Tooltip("Optional text field whitch allows you to OVERRIDE the action lable with your own text.")]
        [SerializeField]
        ...
        private void UpdateActionLabel()
        {
            if (m_ActionLabel != null)
            {
                ...
                else
                {
                    ...
                    m_ActionLabelText = string.Empty;
                }
            }
        }
